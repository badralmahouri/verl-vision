...
def _has_vision_cache(extra_info: dict) -> bool:
    """Check if pretokenized vision cache exists in extra_info."""
    return isinstance(extra_info, dict) and "vision_cache" in extra_info
...
class RLHFDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        # Check for pretokenized vision cache
        extra_info = row_dict.get("extra_info", {})
        has_cache = _has_vision_cache(extra_info)
        ...
        if self.processor is not None:
            ...
            if row_dict_images and not has_cache:
            ...
            # Store vision cache reference for training
            if has_cache:
                row_dict["vision_cache"] = extra_info["vision_cache"]
